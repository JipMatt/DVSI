...
void ChangeArch() {
  ...
  //MY ADDITONS FOR MONORTING
  mon_renyx = mon_renyx_cpu;
  mon_renzx = mon_renzx_cpu;
  mon_ryx = mon_ryx_cpu;
  mon_rzx = mon_rzx_cpu;
  mon_ryz = mon_ryz_cpu;
  mon_rtot = mon_rtot_cpu;
  mon_rxx = mon_rxx_cpu;
  mon_ryy = mon_ryy_cpu;
  mon_rzz = mon_rzz_cpu;
  mon_ektot = mon_ektot_cpu;
  mon_ekx = mon_ekx_cpu;
  mon_eky = mon_eky_cpu;
  mon_ekz = mon_ekz_cpu;
  mon_rhomax = mon_rhomax_cpu;
  mon_rrho = mon_rrho_cpu;
  //END OF MY ADDITONS FOR MONORTING
  comm = comm_cpu;
